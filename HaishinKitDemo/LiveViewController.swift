...
final class LiveViewController: UIViewController {
    ...
    private var beautyViewManager: FUDemoManager!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        beautyViewManager = FUDemoManager(targetController: self, originY: view.frame.height - 250)
